...
- **导入知识卡**：⚙ 里"选择文件夹"批量导入本机 md 知识卡（按 学科/分类 结构归档，同名跳过），立即生效
...
装完重启 `dsh web` 即生效。内置 **1109 张知识卡**（9 学科：数学 396 含高中必修与丛书线、物理 402、化学 289，语数英物化生历地政齐全），无需任何配置。
...
5. ⚙ 挑纸张底色与格线、正文字号、缩放黑板、导入本地知识卡文件夹、勾选重点学科、改高考日期；🔔 开关事件联动；💬 提建议（直达 GitHub Issues）

## 知识卡格式（贡献指南）

一条知识点 = 一个 `.md` 文件，目录层级即**学科 / 分类**：
